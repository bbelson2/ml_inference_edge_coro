...
do
  fn=cnnf64_aw_116_n${height}_llvm
  ...
  do
    ...
    do
      echo ${height}/${tasks}/${width} of 100 200 400/2,4,6,8/2-1024
      ../output/llvm/cnnf64.out -r ${repeats} -e 2 -b 10 -c $tasks -s $width -n $height ${short} -p ${dims} -u cpu_cycles,instructions,d_cache_reads,d_cache_misses -o - -w $hdr -g -f >> ../results/v2/${fn}.csv
