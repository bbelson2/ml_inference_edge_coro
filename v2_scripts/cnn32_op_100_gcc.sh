...
do
  ...
  do
    ...
    do
      ...
      ../output/gcc/cnn32.out -r ${repeats} -e 2 -b 10 -c $tasks -s $width -n $height ${short} -p ${dims} -u cpu_cycles,instructions,d_cache_reads,d_cache_misses -o - -w $hdr -g -f >> ../results/v2/${fn}.csv
